...
class Aretard(Plugin):
    def __init__(self, bot):
        super().__init__(bot)
        self.randomstuffs = ["https://cdn.discordapp.com/attachments/584886538400432154/584890724160503849/Slingshot.mov", "https://media.discordapp.net/attachments/296056831514509312/662123318052257816/oof_2.mp4",
